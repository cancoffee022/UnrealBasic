...
template<> TICTACTOE_API UScriptStruct* StaticStruct<FGameBoardInfo>()
{
	...
	struct Z_CompiledInDeferFile_FID_Users_User_Desktop_UnrealProject_UnrealBasic_TicTacToe_Source_TicTacToe_Private_Struct_GameBoardInfo_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_User_Desktop_UnrealProject_UnrealBasic_TicTacToe_Source_TicTacToe_Private_Struct_GameBoardInfo_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_User_Desktop_UnrealProject_UnrealBasic_TicTacToe_Source_TicTacToe_Private_Struct_GameBoardInfo_h_2733117381(TEXT("/Script/TicTacToe"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Users_User_Desktop_UnrealProject_UnrealBasic_TicTacToe_Source_TicTacToe_Private_Struct_GameBoardInfo_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_User_Desktop_UnrealProject_UnrealBasic_TicTacToe_Source_TicTacToe_Private_Struct_GameBoardInfo_h_Statics::ScriptStructInfo),
		nullptr, 0);
